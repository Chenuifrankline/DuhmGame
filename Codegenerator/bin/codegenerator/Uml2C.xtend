...
class Uml2C {
	...
	new(Map<String, Object> options) {
		...
		registerTemplate(new ArtifactTemplate(), typeof(Artifact), "include")
		registerTemplate(new ArtifactTemplate(), typeof(Artifact), "name")
		registerTemplate(new MainTemplate(), typeof(Model), "main")
